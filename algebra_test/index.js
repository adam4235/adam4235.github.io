...
var STATIC_BASE = 1024,
    ...
    STACKTOP = STACK_BASE,
    STACK_MAX = 161536,
    DYNAMIC_BASE = 5404416,
    DYNAMICTOP_PTR = 161360;
...
var ASM_CONSTS = {
 ...
 133936: function($0) {if (Module['canvas']) { Module['canvas'].style['cursor'] = UTF8ToString($0); } return 0;},  
 134029: function() {if (Module['canvas']) { Module['canvas'].style['cursor'] = 'none'; }},  
 135254: function() {return screen.width;},  
 135281: function() {return screen.height;},  
 135309: function() {return window.innerWidth;},  
 135341: function() {return window.innerHeight;},  
 135419: function($0) {if (typeof setWindowTitle !== 'undefined') { setWindowTitle(UTF8ToString($0)); } return 0;},  
 135553: function() {if (typeof(AudioContext) !== 'undefined') { return 1; } else if (typeof(webkitAudioContext) !== 'undefined') { return 1; } return 0;},  
 135719: function() {if ((typeof(navigator.mediaDevices) !== 'undefined') && (typeof(navigator.mediaDevices.getUserMedia) !== 'undefined')) { return 1; } else if (typeof(navigator.webkitGetUserMedia) !== 'undefined') { return 1; } return 0;},  
